...
#import "XHBValidateUtil.h"

@implementation XHBValidateUtil
...
+(BOOL)isURL:(NSString*)url
{
    ...
    NSArray* array=[regular matchesInString:url options:0 range:NSMakeRange(0, [url length])];
    if (array.count==0) {
        return NO;
    }else{
        return YES;
...
+(BOOL)isUInteger:(NSString*)number
{
    if (number==nil) {
        return NO;
    }
